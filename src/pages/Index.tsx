...
import Img10 from "@/assets/img 10.jpg"; // or .png if it's png
...
const Index = () => {
  ...
  const prevService = () =>
    setServiceSlide((s) => (s === 0 ? totalServices - 1 : s - 1));
  const nextService = () =>
    setServiceSlide((s) => (s === totalServices - 1 ? 0 : s + 1));
  return (
    <div className="min-h-screen bg-background">
            ...
            {stats.map((stat, index) => {
              ...
              return (
                <div key={index} className="text-center">
                  ...
                  <div className="text-pest-black font-medium">
                    {stat.label}
                  </div>
                </div>
              );
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            {/* <h2 className="text-4xl md:text-5xl font-bold text-pest-black mb-6">Our Services</h2>
            <p className="text-xl text-pest-gray max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <Card className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
              <CardContent className="p-6">
                ...
                <p className="text-pest-black font-bold text-center leading-relaxed">
                  Container Fugmigation
                </p>
              </CardContent>
            </Card>
      ...
      <section className="py-16 ">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-bold mb-8 text-pest-black">
              Who We Are
            </h2>
            ...
            {/* Our Services */}
            <div className="mb-12">
              <h3 className="text-2xl font-bold mb-6 text-pest-black">
              ...
              <div className="text-left max-w-2xl mx-auto space-y-3">
                ...
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-primary mt-1 flex-shrink-0" />
                  <p className="text-muted-foreground">
                    Fumigation for shipping companies and export/import houses.
                  </p>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-primary mt-1 flex-shrink-0" />
                  <p className="text-muted-foreground">
                    Fumigation for Wood Packaging Material (ISPM 15 Standards)
            ...
            <div className="mb-12">
              ...
              <div className="text-left max-w-3xl mx-auto space-y-3">
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-primary mt-1 flex-shrink-0" />
                  <p className="text-muted-foreground">
                    Comprehensive Integrated Pest Management Solutions.
                  </p>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-primary mt-1 flex-shrink-0" />
                  <p className="text-muted-foreground">
                    Termite Management - Complete Termite Prevention and
                    Elimination in pre and post Construction structures.
                  </p>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-primary mt-1 flex-shrink-0" />
                ...
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-primary mt-1 flex-shrink-0" />
                  <p className="text-muted-foreground">
                    Eco-friendly products and latest techniques.
                  </p>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-primary mt-1 flex-shrink-0" />
                ...
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-primary mt-1 flex-shrink-0" />
                  <p className="text-muted-foreground">
                    Specialized Treatments for Wood Packaging Material as per
                    NSPM & ISPM 15 Standards of Fumigation Regulations for
                    international trade.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-lg leading-relaxed">
                      Emergency services available with rapid response times.
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-lg leading-relaxed">
                      Post-treatment monitoring and ongoing support services.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 ">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4 text-pest-black">
              Client Testimonials
            </h2>
                ...
                <CardContent className="p-6">
                  <div className="flex mb-4">
                    {[...Array(testimonial.rating)].map((_, i) => (
                      <Star
                        key={i}
                        className="h-5 w-5 text-pest-yellow fill-current"
                      />
                    ))}
                  </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                Contact us today for a comprehensive pest inspection and
                customized solution
              </p>
            </div>
